...
//  Go Racing
//
//  Created by Кулешов Матвей Сергеевич on 3/2/2023.
//
...
class GameViewController: UIViewController {
    ...
    @IBOutlet weak var finishCar: UIImageView!
    ...
    @IBAction func driveCarAction(_ sender: UIButton) {
        ...
        if userCar.center.x > finishCar.center.x {
    ...
    @objc func pcDrive() {
        ...
        if pcCar.center.x > finishCar.center.x {
            gameTimer.invalidate()
            carPcTimer.invalidate()
